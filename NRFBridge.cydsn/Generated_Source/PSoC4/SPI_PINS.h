...
***************************************/
...
#if (SPI_RX_WAKE_SCL_MOSI_PIN)
    #define SPI_RX_WAKE_SCL_MOSI_HSIOM_REG \
                            (*(reg32 *) SPI_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define SPI_RX_WAKE_SCL_MOSI_HSIOM_PTR \
                            ( (reg32 *) SPI_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define SPI_RX_WAKE_SCL_MOSI_HSIOM_MASK \
                            (SPI_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define SPI_RX_WAKE_SCL_MOSI_HSIOM_POS \
                            (SPI_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)

    #define SPI_RX_WAKE_SCL_MOSI_INTCFG_REG \
                            (*(reg32 *) SPI_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define SPI_RX_WAKE_SCL_MOSI_INTCFG_PTR \
                            ( (reg32 *) SPI_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define SPI_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (SPI_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define SPI_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK \
    ...
    #define SPI_TX_HSIOM_PTR   ( (reg32 *) SPI_tx_0__HSIOM)
...
#if (SPI_SS0_PIN)
    #define SPI_CHECK_SS0_PIN_USED \
                (SPI_PIN_DM_ALG_HIZ != \
                    SPI_GET_P4_PIN_DM(SPI_spi_ss0_PC, \
                                                   SPI_spi_ss0_SHIFT))
#endif /* (SPI_SS0_PIN) */
...
#define SPI_REMOVE_SCLK_PIN                SPI_REMOVE_SCLK_PIN
#endif /* SPI_REMOVE_SCLK_PIN */
#ifndef SPI_REMOVE_SS0_PIN
#define SPI_REMOVE_SS0_PIN                 SPI_REMOVE_SS0_PIN
...
#endif /* SPI_SCLK_PIN */
#ifndef SPI_SS0_PIN
#define SPI_SS0_PIN                SPI_SS0_PIN
#endif /* SPI_SS0_PIN */
    ...
    #define SPI_SCLK_HSIOM_REG     SPI_SCLK_HSIOM_REG
    #define SPI_SCLK_HSIOM_PTR     SPI_SCLK_HSIOM_PTR
    #define SPI_SCLK_HSIOM_MASK    SPI_SCLK_HSIOM_MASK
    #define SPI_SCLK_HSIOM_POS     SPI_SCLK_HSIOM_POS
    #endif /* SPI_SCLK_HSIOM_REG */
#endif /* (SPI_SCLK_PIN) */

#if (SPI_SS0_PIN)
    #ifndef SPI_SS0_HSIOM_REG
    #define SPI_SS0_HSIOM_REG      SPI_SS0_HSIOM_REG
    #define SPI_SS0_HSIOM_PTR      SPI_SS0_HSIOM_PTR
    #define SPI_SS0_HSIOM_MASK     SPI_SS0_HSIOM_MASK
    #define SPI_SS0_HSIOM_POS      SPI_SS0_HSIOM_POS
...
#define SPI_SCLK_PIN_INDEX             SPI_SCLK_PIN_INDEX
#endif /* SPI_SCLK_PIN_INDEX */
#ifndef SPI_SS0_PIN_INDEX
#define SPI_SS0_PIN_INDEX              SPI_SS0_PIN_INDEX
...
#define SPI_SCLK_PIN_MASK             SPI_SCLK_PIN_MASK
#endif /* SPI_SCLK_PIN_MASK */
#ifndef SPI_SS0_PIN_MASK
#define SPI_SS0_PIN_MASK              SPI_SS0_PIN_MASK
