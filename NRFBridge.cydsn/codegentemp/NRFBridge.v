// ======================================================================
// NRFBridge.v generated from TopDesign.cysch
// 01/29/2016 at 17:09
...
module SCB_P4_v3_0_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("af59d2ab-9bb4-45bf-9c7f-0a5288229879/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("af59d2ab-9bb4-45bf-9c7f-0a5288229879/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module SCB_P4_v3_0_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("4f70da74-d748-431a-9ef9-f26223590972/38438ec5-732c-47a6-9805-e2b697fb82a2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4f70da74-d748-431a-9ef9-f26223590972/1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4f70da74-d748-431a-9ef9-f26223590972/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4f70da74-d748-431a-9ef9-f26223590972/9613317f-9767-4872-a15a-e07325d93413"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__NRF_CE_net;
	wire [0:0] tmpFB_0__NRF_CE_net;
	wire [0:0] tmpIO_0__NRF_CE_net;
	wire [0:0] tmpINTERRUPT_0__NRF_CE_net;
	electrical [0:0] tmpSIOVREF__NRF_CE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		NRF_CE
		 (.oe(tmpOE__NRF_CE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NRF_CE_net[0:0]}),
		  .io({tmpIO_0__NRF_CE_net[0:0]}),
		  .siovref(tmpSIOVREF__NRF_CE_net),
		  .interrupt({tmpINTERRUPT_0__NRF_CE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NRF_CE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__NRF_IRQ_net;
	wire [0:0] tmpIO_0__NRF_IRQ_net;
	wire [0:0] tmpINTERRUPT_0__NRF_IRQ_net;
	electrical [0:0] tmpSIOVREF__NRF_IRQ_net;

	cy_psoc3_pins_v1_10
		#(.id("1567b181-ee01-4f9d-a5f8-546eaa416f3f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		NRF_IRQ
		 (.oe(tmpOE__NRF_IRQ_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__NRF_IRQ_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
    ...
    CyStatusReg_v1_90 ExtInterrupt_Reg (
        .status_0(Net_34),
        .status_1(Net_35),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .intr(Net_86),
        .status_bus(8'b0));
    defparam ExtInterrupt_Reg.Bit0Mode = 0;
    defparam ExtInterrupt_Reg.Bit1Mode = 0;
    defparam ExtInterrupt_Reg.Bit2Mode = 0;
    defparam ExtInterrupt_Reg.Bit3Mode = 0;
    defparam ExtInterrupt_Reg.Bit4Mode = 0;
    defparam ExtInterrupt_Reg.Bit5Mode = 0;
    defparam ExtInterrupt_Reg.Bit6Mode = 0;
    defparam ExtInterrupt_Reg.Bit7Mode = 0;
    defparam ExtInterrupt_Reg.BusDisplay = 0;
    defparam ExtInterrupt_Reg.Interrupt = 1;
    defparam ExtInterrupt_Reg.MaskValue = 0;
    defparam ExtInterrupt_Reg.NumInputs = 2;

    TCPWM_P4_v2_0_2 Timer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
